  ...
  <div class="h-screen w-screen bg-gray-100 flex items-center">
    <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
      <div class="max-w-md">
        ...
        <p class="text-2xl md:text-3xl font-light leading-normal">Your access is forbidden! </p>
        <p class="mb-8">Sorry we couldn't find this page.</p>

        <a href="<?= base_url('user') ?>" class="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-md focus:outline-none focus:shadow-outline-blue bg-blue-600 active:bg-blue-600 hover:bg-blue-700">back to homepage</a>
      </div>
      <div class="max-w-lg">
        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2395 1800" width="400" class="animate-bounce">
          <defs>
            <style>
              .cls-1 {
                fill: #d6b49a;
